...
<body>
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <h5 class="breadcrumbs-title">Daftar Katalog</h5>
      <a href="tambah-katalog" class="btn btn2 btn-prev btn-success ">Tambah Katalog</a>
      <br><br>
      <table id="myTable" class="display responsive nowrap" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <a href="edit-katalog?id_katalog='.$data["id_katalog"].'&nama='.$data["nama"].'">
                    <button type="button" class="btn waves-effect waves-light green darken-1">Edit</button></a>

                    <a href="config/hapus?id_katalog='.$data["id_katalog"].'">
