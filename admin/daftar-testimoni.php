...
<body>
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <h5 class="breadcrumbs-title">Daftar Testimoni</h5>
      <table id="myTable" class="display responsive nowrap" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <button type="button" class="btn waves-effect waves-light green darken-1">Terima</button></a>

                    <a href="config/update?id_testi='.$data["id_testi"].'&status=Ditolak">
                    <button type="button" class="btn waves-effect waves-light purple lightrn-1">Tolak</button></a>
