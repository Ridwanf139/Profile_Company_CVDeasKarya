...
<body>
  ...
  <div class="container">
    <div class="row pt-2 text-center">
      ...
      <div class="row pt-5 ml-3 justify-content-center">
        ...
        $query       = "SELECT * FROM tbl_jasa WHERE kategori='Bidang IT' order by id_jasa asc"; 
        $sql         = mysqli_query($connection, $query); 
        while($data  = mysqli_fetch_array($sql)){ ?>
        
        <div class="col-4">
          <figure class="figure">
            <img src="img/jasa/<?php echo $data['thumbnail']; ?>" class="figure-img img-fluid">
            <figcaption class="figure-caption">
              <h5><?php echo $data['judul']; ?></h5>
              <a href="detail.php?id_jasa=<?php echo $data['id_jasa']; ?>" class="btn btn-info text-white">Details</a>
            </figcaption>
          </figure>
        </div>
  ...
  <div class="container">
    <div class="row text-center">
        <div class="col">
            <h3>Bidang Hiburan</h3> 
      </div>

      <div class="row pt-5 ml-3 justify-content-center">
      <?php
        $query       = "SELECT * FROM tbl_jasa WHERE kategori='Bidang Hiburan' order by id_jasa asc"; 
        $sql         = mysqli_query($connection, $query); 
        while($data  = mysqli_fetch_array($sql)){ ?>
